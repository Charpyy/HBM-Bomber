...
public class ClientProxy extends ServerProxy {
	...
	public void registerRenderInfo()
	{
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityNukeExplosionMK6.class, RenderNukeMK6.FACTORY);
	...
	public void preInit(FMLPreInitializationEvent evt){
		...
		ModItems.gun_jshotgun.setTileEntityItemStackRenderer(new ItemRenderJShotgun());

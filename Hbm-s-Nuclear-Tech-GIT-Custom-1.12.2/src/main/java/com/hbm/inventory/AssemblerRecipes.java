...
//		makeRecipe(new ComparableStack(ModItems.australium_iii, 1), new AStack[] { new ComparableStack(ModItems.rod_australium, 1), new OreDictStack(STEEL.ingot(), 1), new OreDictStack(STEEL.plate(), 6), new OreDictStack(CU.plate(), 2), new ComparableStack(ModItems.wire_copper, 6), }, 150);
		...
		//Batteries
		makeRecipe(new ComparableStack(ModBlocks.machine_battery, 1), new AStack[] {
                new OreDictStack(STEEL.ingot(), 4),
                new OreDictStack(S.dust(), 12),
                new OreDictStack(PB.dust(), 12),
                new OreDictStack(MINGRADE.ingot(), 2),
                new ComparableStack(ModItems.wire_copper, 2), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_lithium_battery, 1), new AStack[] { 
			...
			new OreDictStack(ALLOY.ingot(), 4),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_desh_battery, 1), new AStack[] { 
			...
			new OreDictStack(GRAPHITE.ingot(), 4),
			new OreDictStack(CD.nugget(), 2), }, 400);
...
//		makeRecipe(new ComparableStack(ModItems.grenade_black_hole, 1), new AStack[] { new OreDictStack(ANY_PLASTIC.ingot(), 6), new OreDictStack(OreDictManager.getReflector(), 3), new ComparableStack(ModItems.coil_magnetized_tungsten, 2), new ComparableStack(ModItems.black_hole, 1), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_core, 1), new AStack[] { new OreDictStack(SA327.ingot(), 10), new ComparableStack(ModItems.ingot_tennessine, 5), }, 400);
